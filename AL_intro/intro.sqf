...
_firstshot = [cam3, cam4, target2, 12, 1, 1, false, 0, 0, 0,FALSE] execVM "AL_intro\camera_work.sqf";
waitUntil {scriptdone _firstshot};

_txt_1 = ["Operation Everon",10,"center","3","#618500"] execVM "AL_intro\txt_display.sqf";
// -------------------------------------
_secondshot = [cam1, cam2, target1, 10, 1, 1, false, 0, 0, 0,FALSE] execVM "AL_intro\camera_work.sqf";
waitUntil {scriptdone _secondshot};

_txt_2 = ["Made by Hexperience",7,"center_bottom","1","#FFFFFF"] execVM "AL_intro\txt_display.sqf";
// -------------------------------------
_thirdshot = [cam5, cam6, target3, 7, 1, 1, false, 0, 0, 0,TRUE] execVM "AL_intro\camera_work.sqf";
